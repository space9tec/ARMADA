...
// class AddMachine2 extends StatefulWidget {
//   static const String routeName = '/AddMachine22';

//   static Route route() {
//     return MaterialPageRoute(
//       settings: const RouteSettings(name: routeName),
//       builder: (context) {
//         return const AddMachine2();
//       },
//     );
//   }

//   const AddMachine2({super.key});

//   @override
//   State<AddMachine2> createState() => _AddMachine2State();
// }

// class _AddMachine2State extends State<AddMachine2> {
...
//                 ],
//               ),
//               if (_currentCarType == 'Tractor') _buildTractorInputs(),
//               if (_currentCarType == 'Combineharvester')
//                 _buildCombineharvesterInputs(),
//               if (_currentCarType == 'Thresher') _buildThresherInputs(),
//               if (_currentCarType == 'TractorAttachments')
//                 _buildTractorAttachmentsInputs(),
//               if (_currentCarType == 'Other') _buildOtherInputsO(),
//               if (_currentCarType == 'TractorAttachments')
...
//                           "/api/machinery/", data, "machineData", imageFile!);
...
//   Widget _buildCombineharvesterInputs() {
//     return Form(
//       key: _formKey,
//       child: Column(
//         children: [
